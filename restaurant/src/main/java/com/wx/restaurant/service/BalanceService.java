...
public class BalanceService {
    ...
    public Balance balanceFind(String orderId) {
        return balanceMapper.balanceFind(orderId);
    }

    public List<ShopCart> shopCartList(String orderId) {
        return shopCartMapper.shopCartList(orderId);
    }
}
